...
public class LoginPage extends TestBase
{
	...
	@FindBy(xpath=".//input[@id='pLogin'][@name='PASSWORD']") static WebElement password;
	...
	public static  HomePage LogintoNaukari(String un, String pwd)
	{
		driver.findElement(By.name("email")).sendKeys(un);
		driver.findElement(By.xpath("//input[@id='pLogin'][@name='PASSWORD']")).sendKeys(pwd);
		driver.findElement(By.xpath("//button[@value='Login'][@class='blueBtn']")).click();
